        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-lg shadow-sm p-8 flex flex-col items-center text-center">
            <div className="relative w-40 h-40 mb-6">
              <Image
                src="/placeholder.svg?height=160&width=160&text=Buy+a+home"
                alt="Buy a home"
                fill
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 flex flex-col items-center text-center">
            <div className="relative w-40 h-40 mb-6">
              <Image
                src="/placeholder.svg?height=160&width=160&text=Sell+a+home"
                alt="Sell a home"
                fill
                className="object-contain"
                sizes="160px"
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 flex flex-col items-center text-center">
            <div className="relative w-40 h-40 mb-6">
              <Image
                src="/placeholder.svg?height=160&width=160&text=Rent+a+home"
                alt="Rent a home"
                fill
                className="object-contain"
                sizes="160px"
